...
This API performs read/write to a database based on client request.
...
3. Successfully registered user can perform CRUD functionalities to the database as required.
